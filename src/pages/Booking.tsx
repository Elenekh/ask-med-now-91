  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <h1 className="mb-2 text-3xl font-bold text-foreground">Book Your Appointment</h1>
          <p className="text-muted-foreground">Select a date and time for your visit</p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6">
            <Card className="bg-gradient-card p-6 shadow-card">
              ...
              {date && (
                <div>
                  <Label className="mb-3 block text-lg">Available Time Slots</Label>
          ...
          <div>
            <Card className="sticky top-4 bg-gradient-card p-6 shadow-card">
              <h3 className="mb-4 text-lg font-semibold text-card-foreground">Appointment Summary</h3>
